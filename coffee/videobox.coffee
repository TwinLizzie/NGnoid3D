...
class videobox
  ...
  display_proxy_warn: =>
    if window.location.origin is "https://portal.ngnoid.tv"
      $("#videobox").html "<p style='color: white; margin-left: 10px'>Your model list is empty.</p><p style='color: white; margin-left: 10px'>New to ZeroNet? Check out the PC and mobile client at <a href='https://zeronet.dev'>ZeroNet.dev</a></p><p style='color: white; margin-left: 10px'>If you're on Linux, simply clone my <a href='https://github.com/TwinLizzie/ZeroNet'>Github repository</a> and run python3 zeronet.py</p>" 
