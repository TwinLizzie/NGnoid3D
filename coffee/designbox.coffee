...
class designbox
  ...
  update: =>
    ...
    Page.cmd "dbQuery", ["SELECT * FROM design LEFT JOIN json USING (json_id) "+query+" ORDER BY date_added DESC"], (res1) =>
      Page.cmd "optionalFileList", {filter: "", limit: 1000}, (res2) =>

        $("#videobox").html ""
        $("#more_videos").html "<div class='more_videos text'>More designs!</div>"
        ...
        for row1, i in res1
          for row2, j in res2
            ...
            if video_name is file_name and video_user_address is Page.site_info.auth_address and @counter < @max_videos
              ...
              video_edit_link.attr "href", "?DesignEditor=" + video_string
              ...
              video_link.attr "href", "?DesignView=" + video_string
