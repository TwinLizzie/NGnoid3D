...
class top_menuify
  render: =>
    ...
    design_link = $("<a></a>")
    design_link.attr "id", "design_link"
    design_link.attr "class", "upload_link"
    design_link.attr "href", "?DesignCreate"

    design_icon = $("<div></div>")
    design_icon.attr "id", "main_design"
    design_icon.attr "class", "main_design"
    ...
    $("#menu_top").append design_link
    $("#design_link").html design_icon    
